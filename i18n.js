const translations = {
    ...
    ja: {
        ...
        upload_label: "クリックまたはドラッグしてビデオ를 업로드",
        upload_label_crop: "クリックまたはドラッグしてクロップするビデオをアップロード",
        upload_label_merge: "結合する MP4 ファイルを選択してください（複数可）",
        upload_label_sync_video: "ビデオファイルを選択",
        upload_label_sync_audio: "オーディオファイルを選択",
        ...
        video_info_label: "ビデオ情報",
        audio_info_label: "オーディオ情報",
        sync_btn: "オーディオの長さに合わせてビデオ速度を調整",
        // New Features
